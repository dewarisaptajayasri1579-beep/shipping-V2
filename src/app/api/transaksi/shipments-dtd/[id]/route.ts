...
import { updateDeleteHandlers, requiredString, optionalString, numberOrZero, enumValue } from "@/lib/data/api-helpers"
...
export const { PATCH, DELETE } = updateDeleteHandlers<ShipmentDtd, ShipmentDtdInput>(shipmentDtdStore, sanitize)
