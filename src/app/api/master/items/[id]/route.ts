...
import { updateDeleteHandlers, requiredString, optionalString } from "@/lib/data/api-helpers"
...
export const { PATCH, DELETE } = updateDeleteHandlers<Item, ItemInput>(itemStore, (body) => {
