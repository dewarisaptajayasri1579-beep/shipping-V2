...
export const CurrencyInput = React.forwardRef<HTMLInputElement, CurrencyInputProps>(
  ({ label, helperText, error, value, onChange, sizeVariant = "lg", placeholder = "0", disabled, className = "", id, onKeyDown }, ref) => {
